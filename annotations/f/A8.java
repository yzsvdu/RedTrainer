...
public final class A8 extends Wr implements r60 {
    public final pA cq;
    public final Ip mg0;
    public vF0 TK;
    public vF0 K00;
    ...
    public final boolean i2(oa0 paramoa0) {
        ...
        /*  4 */
        if (B8.Wm0(paramoa0.cz0) && paramoa0
/*  5 */.oO())
            /*    */ {
            dL0 dL0;
            int i;
            /*  7 */
            if (h1.J20(i = paramoa0.GG0, BM.N70)) {
                /*    */
                fH0 fH0;
                /*    */
                /* 10 */
                short s = (fH0 = km.u4.Lz).aY;
                if (this.cl == 0 && (i = this.Kb) <= 2 && ++i <= s) {
                    this
                            /* 11 */.Kb = (byte) i;
                    /* 12 */
                    fH0.aY = (short) (s - 1);
                    /* 13 */
                    km.pm0.bL((byte) 0, (short) 88);
                    this.Kb = 3;
                    if (this.Kb > 3 && this
                            /* 14 */.cl == 0) {
                        for (this.cl = 1, this.lx = null, i = 0; i < this.Lp0.length; ) {
                            this.P80[i] = false;
                            i++;
                        }
                        dL0 = dL0.Ab0;
...
/* 15 */.FL(dL0, this.Kb, (short) 0);
                ...
                this.TK
/* 19 */.TS
/* 20 */.qt(new U70[]{WB0.QJ0().OL0(this.Kb)});
                return true;
                /* 21 */
            }
            if (h1.J20(dL0, BM.lc)) {
                if (this.Kb == 0 && this.cl == 0) {
                    this.cq.sW(false);
                    km.u4
/* 22 */.FL(dL0.Ab0, (byte) -1, (short) 0);
            ...
            /* 23 */
                ...
                byte b;
                if (h1.J20(dL0, BM.bC)) {
                    if ((b = this.cl) == 0 && this.Kb > 0) {
                        if (b == 0) {
                            for (this
                                         /* 24 */.cl = 1, this.lx = null, b = 0; b < this.Lp0.length; ) {
                                this.P80[b] = false;
                                b++;
                            }
                            dL01 = dL0.Ab0;
                            km.u4
/* 25 */.FL(this, this.Kb, (short) 0);
                        }
                        return true;
                    }
                    if (((A8) super)
                    ...
                    b = 0; /* monitor enter ClassFileLocalVariableReferenceExpression{type=ObjectType{I, dimension=1}, name=null} */
                    while (b < ((A8) super).Lp0.length) {
                        if (!((A8) super).P80[b]) {
                            int[] arrayOfInt;
                            byte b1;
                            try {
                                short s = 48;
                                ((A8) super).h2[b] = 24 - (((A8) super).lx[b] + 1) * s; /* monitor exit BinaryOperatorExpression{ClassFileLocalVariableReferenceExpression{type=ObjectType{I, dimension=1}, name=null} = FieldReferenceExpression{lastType=ObjectType{I, dimension=1}, expression=SuperExpression{ObjectType{f/dL0}}, name=h2, descriptor=[I}} */
                                ((A8) super).P80[b] = true;
                                km.pm0.bL((byte) 0, (short) 24);
                                if (b == ((A8) super).Lp0.length - 1) {
                                    ArrayList<Byte> arrayList;
                                    this();
                                    s = ((A8) super).Kb;
                                    byte[] arrayOfByte = ((A8) super).lx;
                                    byte[][] arrayOfByte1;
                                    byte b2;
                                    for (arrayOfByte1 = new byte[3][3], b2 = 0; b2 < 3; ) {
                                        byte b3;
                                        if ((b3 = arrayOfByte[b2]) == 0) {
                                            arrayOfByte1[b2][0] = FP.Wb0[b2][(FP.Wb0[b2]).length - 1];
                                        } else {
                                            arrayOfByte1[b2][0] = FP.Wb0[b2][b3 - 1];
                                        }
                                        byte[] arrayOfByte2, arrayOfByte3;
                                        (arrayOfByte2 = arrayOfByte1[b2])[1] = (arrayOfByte3 = FP.Wb0[b2])[arrayOfByte[b2]];
                                        byte b4;
                                        if ((b4 = arrayOfByte[b2]) == arrayOfByte3.length - 1) {
                                            arrayOfByte2[2] = arrayOfByte3[0];
                                        } else {
                                            arrayOfByte2[2] = arrayOfByte3[b4 + 1];
                                        }
                                        b2++;
                                    }
                                    short s1 = 0;
                                    b2 = arrayOfByte1[1][1];
                                    s1 = (short) (FP.vR(arrayOfByte1[0][1], b2, arrayOfByte1[2][1]) + s1);
                                    if (s > 0 && FP.vR(arrayOfByte1[0][1], b2, arrayOfByte1[2][1]) > 0)
                                        arrayList.add(Byte.valueOf((byte) 0));
                                    if (s > 1) {
                                        b2 = arrayOfByte1[1][0];
                                        s1 = (short) (s1 + FP.vR(arrayOfByte1[0][0], b2, arrayOfByte1[2][0]));
                                        if (FP.vR(arrayOfByte1[0][0], b2, arrayOfByte1[2][0]) > 0)
                                            arrayList.add(Byte.valueOf((byte) 1));
                                        b2 = arrayOfByte1[1][2];
                                        s1 = (short) (s1 + FP.vR(arrayOfByte1[0][2], b2, arrayOfByte1[2][2]));
                                        if (FP.vR(arrayOfByte1[0][2], b2, arrayOfByte1[2][2]) > 0)
                                            arrayList.add(Byte.valueOf((byte) 2));
                                    }
                                    if (s > 2) {
                                        s = arrayOfByte1[1][1];
                                        s = (short) (s1 + FP.vR(arrayOfByte1[0][0], s, arrayOfByte1[2][2]));
                                        if (FP.vR(arrayOfByte1[0][0], s, arrayOfByte1[2][2]) > 0)
                                            arrayList.add(Byte.valueOf((byte) 3));
                                        s1 = arrayOfByte1[1][1];
                                        s1 = (short) (s + FP.vR(arrayOfByte1[0][2], s1, arrayOfByte1[2][0]));
                                        if (FP.vR(arrayOfByte1[0][2], s1, arrayOfByte1[2][0]) > 0)
                                            arrayList.add(Byte.valueOf((byte) 4));
                                    }
                                    if (s1 > 0) {
                                        JD jD;
                                        ((A8) super).cl = 2;
                                    9    km.pm0.Yt0((byte) 0, (short) 269);
                                        ((A8) super).kd0 = s1;
                                        super.wA();
                                        ((A8) super).Kb = 0;
                                        ((A8) super).TK.TS.qt(new U70[]{WB0.QJ0().OL0(((A8) super).Kb)});
                                        boolean bool1 = arrayList.contains(Byte.valueOf((byte) 0)), bool2 = arrayList.contains(Byte.valueOf((byte) 1)), bool3 = arrayList.contains(Byte.valueOf((byte) 2)), bool4 = arrayList.contains(Byte.valueOf((byte) 3)), bool5 = arrayList.contains(Byte.valueOf((byte) 4));
                                        ((A8) super).K00.TS.qt(new U70[]{WB0.QJ0().UK0(bool1, bool2, bool3, bool4, bool5)});
                                        ((A8) super).K00.wI0(true);
                                        this((A8) this);
                                        HC.k6().S(jD, 2.5F);
                                    } else {
                                        super.hh();
                                ...
                                dL01 = null; /* monitor exit ClassFileLocalVariableReferenceExpression{type=PrimitiveType{primitive=maybe_byte}, name=null} */
                            }
                        }
                        b++;
                    }
                ...
                if (b == 66 && ((A8) super).Kb == 3) ((A8) super).Kb = -1;
            }
        }
        return false;
    }
