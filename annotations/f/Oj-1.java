/*  1 */ package f;public final class Oj extends Pw { public final void Gn0() { if (kJ0.st0) { Kv kv; this(UB0.go); UB0.re0 = UB0.go = new Kv(); UB0.M60.zW = kv; }  super
/*  2 */       .Gn0();
/*  3 */     fl0.IJ0("lwjgl_version", Version.getVersion(), "LWJGL version", false);
/*  4 */     this(); pE pE1; kS kS; (kS = new kS())
/*  5 */       .t20 = this.RX;
/*    */     Texture texture;
/*  7 */     if ((texture = (interface.ZZ()).xs) == null) { texture = null; }
/*  8 */     else { pE pE2; tw tw = km.wI0.zn; int i = texture.getWidth(), j = texture.getHeight(), k = texture.getWidth(), m = texture.getHeight(); pRn pRn = pRn.WHITE; this(tw, texture, i, j, k, m, pRn); pE1 = pE2; }  this
/*  9 */       .mT = pE1; try { js js = this.js0; tw tw = this.zn; xR xR = km.ek; Tm tm = this.zb; (this.LK = new Rp0(this, js, tw, kS, xR, tm))
/* 10 */         .xQ = false; } catch (Exception exception) { exception
/* 11 */         .printStackTrace(); }  Rp0 rp0; if ((rp0 = this.LK) != null) { kS
/* 12 */         .NF = rp0;
/* 13 */       km.ek
/* 14 */         .Ue
/* 15 */         .Com3(kS);
/* 16 */       Rp0 rp01 = this.LK; String str; dS dS;
/* 17 */       if ((dS = as0(this.zn, str = h1.MW)) != null) { dS dS2; if ((dS2 = this.Iv) != null) dS2.Ka0();  this.Iv = dS; rp01.XX(dS); rp01.Pb0(500); dS dS1; if (this.Z5 != null && (dS1 = as0(this.tH, str)) != null) this.Z5.XX(dS1);  }
/* 18 */        km.iE0.LY(h1.c20); }
/*    */      }
/*    */ 
/*    */   
