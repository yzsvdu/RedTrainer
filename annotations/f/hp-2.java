/* 1 */ package f;public final class hp implements Comparator { public final int compare(Object paramObject1, Object paramObject2) { sM sM = (sM)paramObject1; int i; if ((i = ((sM)(paramObject1 = paramObject2)).h9 - this.h9) == 0)
