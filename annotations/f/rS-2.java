/*  1 */ package f;public final class rS extends JG0 { public static final Ll COm9; public static final Ll hD; public static final Ll cOM6; public static final Ll mT; public static final NC0 F2; public final Ja Fd0; public final Ja PB; public final JG0 z9; public Nj JB0; public JG0 iR; public int YP; public db Wk; public db pq0; public db W6; public boolean t8; public boolean w30; public boolean mV; public int Sr; public static rS ck(JG0 paramJG0) { JG0 jG0; if ((jG0 = paramJG0.fr0) != null && 
/*  2 */       jG0 = jG0.fr0 instanceof rS)
/*  3 */     { jG0 = jG0; if (v3 || ((rS)jG0)
/*  4 */         .iR == paramJG0)
/*  5 */         return (rS)jG0;  throw new AssertionError(); }  return null; }
/*    */   public YG ez0;
/*  7 */   public long Ep; public float VK0; public float Fz0; public float tv; public float tK; public float Ly; public float ze0; public float qs; public boolean EG0; public boolean catch; public boolean eK0; public float CL0; public cx0 gl; public float V10; public boolean P2; public rS() { this(null); } public rS(JG0 paramJG0) { cx0 cx01; Ja ja1; Ja ja2; this.YP = 1; db db1 = db.oI; this.pq0 = db1; this.W6 = db1; this.Ep = 0L; this.VK0 = 0.0F; this.EG0 = false; this.catch = true; this.eK0 = true; this.CL0 = 50.0F; this(); this.gl = cx01; this.V10 = 1.0F; this.P2 = true; this(1); this.Fd0 = ja1; this(2); this.PB = ja2; this(); this.z9 = jG0; Runnable runnable; ja1.XI0(runnable = this::BB0); ja1.wI0(true); ja2.XI0(this); ja2.wI0(true); JG0 jG0; (jG0 = new JG0()).xL0(); (new JG0()).Xu(""); super.si(jG0, 0); super.si(ja1, 1); super.si(ja2, 2); Gz0(paramJG0); Zf0(true); } public static Stream pz0(JG0 paramJG0) { return Arrays.stream(paramJG0.Li0.Uq0); } static { COm9 = Ll.F10("downArrowArmed"); hD = Ll.F10("rightArrowArmed"); cOM6 = Ll.F10("horizontalScrollbarVisible"); mT = Ll.F10("verticalScrollbarVisible"); Ll.F10("autoScrollUp"); Ll.F10("autoScrollDown"); F2 = new NC0(); } public final void cF() { this.Ep = System.currentTimeMillis(); float f; if ((f = this.VK0) > 0.0F) { f = UB0.M60.Qy; this.V10 = 0.5F; float f1 = f / 0.5F; Ja ja; float f3 = (ja = this.Fd0).Ny0; float f4 = this.PB.Ny0;
/*  8 */       this.eK0 = false; this.CL0 = 0.0F; this.tK = f3 = Oq.R0(this.Fz0, f1, f, f3); this.Ly = Oq.R0(this.tv, f1, f, f4);
/*  9 */       if (this.catch) {
/*    */         
/* 11 */         int i = (int)nx0.SA0(f3, 0.0F, ja.sy);
/* 12 */         this.Fd0
/* 13 */           .Fk0(i, true);
/* 14 */         if (this.eK0)
/*    */         { float f5;
/*    */           
/* 17 */           int j = (int)nx0.SA0(this.Ly, -(f5 = this.CL0), this.PB.sy + f5); }
/*    */         else
/*    */         
/* 20 */         { i = (int)nx0.SA0(this.Ly, 0.0F, this.PB.sy); }  rt(i);
/* 21 */       }  float f2; if ((f1 = this.tK) == (f3 = -(f2 = this.CL0))) this.Fz0 = 0.0F;  if (f1 >= 
/* 22 */         this.Fd0
/* 23 */         .sy + f2) this
/* 24 */           .Fz0 = 0.0F;  if ((f1 = this.Ly) == f3) this.tv = 0.0F;  if (f1 >= 
/* 25 */         this.PB
/* 26 */         .sy + f2) this
/* 27 */           .tv = 0.0F;  if ((this.VK0 -= f) <= 0.0F) { this.Fz0 = 0.0F; this.tv = 0.0F; }
/*    */        }
/*    */      }
/*    */ 
/*    */   
