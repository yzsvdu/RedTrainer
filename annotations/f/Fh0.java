...
public final class Fh0 extends Uy {
  public static final Fh0 JC = new Fh0();
  
  public static int[] bx0 = new int[] { 
  ...
  public final void on(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    while (paramInt1 < paramInt2) {
      i = i >>> 8 ^ bx0[(i ^ paramArrayOfbyte[paramInt1]) & 0xFF];
      paramInt1++;
    } 
    paramArrayOfbyte[paramInt1] = (byte)i;
    i = paramInt1 + 1;
    paramArrayOfbyte[i] = (byte)(i >> 8);
  }
  
  public final boolean Sb0(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    int i;
    if ((i = paramInt2 - 2) < 0)
      return false; 
    paramInt2 = 0;
    i = paramInt1 + i;
    while (paramInt1 < i) {
      paramInt2 = paramInt2 >>> 8 ^ bx0[(paramInt2 ^ paramArrayOfbyte[paramInt1]) & 0xFF];
      paramInt1++;
    } 
    return (paramInt2 == (paramArrayOfbyte[paramInt1] & 0xFF | (paramArrayOfbyte[paramInt1 + 1] & 0xFF) << 8));
  }
}


/* Location:              /Users/vnnsnnt/Documents/Codespace/JavaWorkspace/RedTrainer/src/main/java/org/trainer/client/PokeMMO.jar!/f/Fh0.class
