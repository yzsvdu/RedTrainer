/* 1 */ package f;public final class j40 extends Qh0 { public final String m() { if (this.Zs.YC())
/*   */     {
/*   */       
/* 4 */       return Ml0.Go(1893, this.VP.o60(false));
/*   */     }
/* 6 */     if (!this.Zs.nr.isEmpty())
/* 7 */       return this.Zs.nr;  UD0 uD0;
/* 8 */     if ((uD0 = this.VP) == null) return "???"; 
/* 9 */     return o60(false); }
/*   */ 
/*   */   
/*   */   public Q90 Zs;
