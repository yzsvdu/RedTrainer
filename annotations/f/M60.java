/*  1 */ package f;public final class M60 extends Qa0 implements r60 { public static int mo0 = -1; public final Vq0 abstract; public IN O80; public final dQ[] lG0; public IN zn0; public Ip Yi; public Ip xw; public Ip Lpt2; public Ip aq0; public Ip af; public Ip Com7; public Ip fA; public Ip Gc; public Ip QK; public Ip vx; public Ip Nh0; public Ip Am; public Ip v00; public Li0 rR; public Un pr0; public int te0; public My0 vy; public int E30; public int GE0; public int jB; public fQ QB; public static void K9(j40 paramj40) { km.u4
/*    */       
/*  3 */       .lF(B40.df("//clonepokemon ").append(paramj40.Jg).toString()); }
/*    */    public fQ zH0; public Uc0 Be0; public vF0 qD0; public vF0 lpT9; public vF0 Ar; public vF0 bI; public vF0 IO; public Q20 o4; public vF0 m4; public vF0 Wz0; public break mn; public pRn si0; public JG0 FX; public Un V7; public int Ug; public boolean z; public ParticleEffectExt Xv0; public Ht0 nj0; public kg0 gj; public tU XB; public boolean My; public fQ Pf; public UA0[] T; public int ny0; public Un sS; public So coM5; public YG uH; public static void D7(short paramShort) {
/*  5 */     km.u4.lF(HB0.DH0("//setot ", paramShort, " ").append(km.a3.Ct.ED0).toString()); } public static void PH(short paramShort, int paramInt) { km.u4.lF(B40.df("//setballtype ").append(km.a3.Ct.ED0).append(" ").append(paramShort).append(" ").append(paramInt).toString()); } public static void MD0(short paramShort, mA parammA) { km.u4.lF(HB0.DH0("//addparticle ", paramShort, " ").append(parammA.WF).toString()); } public static void LPt6(short paramShort) { mA[] arrayOfMA; int i; byte b; for (i = (arrayOfMA = mA.Uk).length, b = 0; b < i; ) { mA mA = arrayOfMA[b]; km.u4.lF(HB0.DH0("//addparticle ", paramShort, " ").append(mA.WF).toString()); b++; }  } public static void IV(short paramShort, int paramInt) { km.u4.lF(B40.df("//setability ").append(km.a3.Ct.ED0).append(" ").append(paramShort).append(" ").append(paramInt).toString()); } public static void Bu(short paramShort, boolean paramBoolean) { km.u4.lF(B40.df("//setsecretshiny ").append(km.a3.Ct.ED0).append(" ").append(paramShort).append(" ").append(paramBoolean).toString()); } public static void dy(short paramShort, boolean paramBoolean) { km.u4.lF(B40.df("//setshiny ").append(km.a3.Ct.ED0).append(" ").append(paramShort).append(" ").append(paramBoolean).toString()); } private void Tz0() { UA0[] arrayOfUA02; int i; byte b; for (i = (arrayOfUA02 = this.T).length, b = 0; b < i; ) { arrayOfUA02[b].run(); b++; }  UA0 uA0 = this[0]; UA0[] arrayOfUA01; (arrayOfUA01 = this.T)[1].getClass(); ((arrayOfUA01 = this.T)[1]).vF0 = this.vF0; ((arrayOfUA01 = this.T)[1]).YM = this.YM; ((arrayOfUA01 = this.T)[1]).rS = this.rS; } private void gL(j40 paramj401, j40 paramj402) { pA.Dg0.Um(paramj401.Jg); JG0 jG0 = this.FX;
/*    */     
/*  7 */     pA.Dg0.Qd0(paramj402, this, this.te0, true).BA(); } private void Ap(j40 paramj40, pA parampA) { // Byte code:
/*    */     //   0: aload_1
...
/*  8 */         VA0.c90(this);  parampA
/*    */         
/* 10 */         .Um(paramj40.Jg); return; }  mo0 = paramj40.Jg; super.Pb0(true); } public static void EK(j40 paramj40, Sj paramSj) { boolean bool; if (km.MR != null) { if (paramj40.Zs.xH != mA.BI) { bool = false; } else { bool = true; }  paramSj.TG0.Fx0(bool); return; }  R8 r8 = km.u4; int i = bool.Jg; mA mA; if (bool.Zs.xH == (mA = mA.BI)) mA = mA.uZ;  r8
/* 11 */       .e20
/* 12 */       .W3(new coM1(i, mA)); } public static void Go0(j40 paramj40, mA parammA, Sj paramSj) { boolean bool; if (km.MR != null) { if (paramj40.Zs.xH != parammA) { bool = false; } else { bool = true; }  paramSj.TG0.Fx0(bool); } else { R8 r8 = km.u4; int i = bool.Jg; if (bool.Zs.xH == parammA) parammA = mA.uZ;  r8.e20.W3(new coM1(i, parammA)); }  } public static void h40(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)3, (byte)2, i); } public static void p2(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)2, (byte)1, i); } public static void nF(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)1, (byte)0, i); } public static void YF0(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)2, (byte)3, i); } public static void Yl0(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)1, (byte)2, i); } public static void Vz(j40 paramj40) { int i = paramj40.Jg; km.u4.Aw((byte)0, (byte)1, i); } public static void Ee(j40 paramj40) { this(); ag.V9(paramj40.Zs.lG()); ag.yd0('\t'); (new SimpleDateFormat("hh:mm:ss a z")).setTimeZone(TimeZone.getTimeZone("UTC")); ag.V9((new SimpleDateFormat("hh:mm:ss a z")).format(Long.valueOf(paramj40.Zs.Ck * 1000L))); ag.yd0('\t'); ag.V9(paramj40.Hn()); ag.V9(" (");
/*    */ 
/*    */     
/* 15 */     ag.Td(paramj40.Zs.Cw0)
/* 16 */       .V9(")");
/* 17 */     ag.Td(paramj40.Zs.Cw0).yd0('\t');
/*    */ 
/*    */     
/* 20 */     ag.Td(paramj40.Zs.sq0)
/* 21 */       .yd0('\t');
/*    */ 
/*    */ 
/*    */     
/* 25 */     ag.V9(paramj40.Zs.k0.cK0());
/* 26 */     ag.yd0('\t');
/*    */     
/* 28 */     ag.Td(paramj40.Zs.Hc(hR.Gg))
/* 29 */       .yd0('\t');
/*    */     
/* 31 */     ag.Td(paramj40.Zs.Hc(hR.zh))
/* 32 */       .yd0('\t');
/*    */     
/* 34 */     ag.Td(paramj40.Zs.Hc(hR.kq))
/* 35 */       .yd0('\t');
/*    */     
/* 37 */     ag.Td(paramj40.Zs.Hc(hR.Xx))
/* 38 */       .yd0('\t');
/*    */     
/* 40 */     ag.Td(paramj40.Zs.Hc(hR.PE0))
/* 41 */       .yd0('\t');
/*    */     Ag ag;
/* 43 */     (ag = new Ag()).Td(paramj40.Zs.Hc(hR.s5)); km.u4.Pq("Copied to clipboard");
/*    */     
/* 45 */     String str = ag.toString(); UB0.Kg0.fl0.getClass();
/*    */ 
/*    */ 
/*    */     
/* 49 */     GLFW.glfwSetClipboardString(UB0.M60.AW.ne0, str); } public final void Xp0(j40 paramj40, boolean paramBoolean) { float f; short s1 = paramj40.Zs.Cw0; byte b = 2; Uf0 uf0; if ((uf0 = um0.Kt0.da[b]) == null) { f = 0.0F; } else { f = uf0.Sp(f); }  if (f == 0.0F) if (km.XU()) { f = 4.0F; } else { f = 2.0F; }   if (this.ny0 == 0) { j = 1; } else { j = 0; }  short s2 = paramj40.Zs.Vf0(); zh0 arrayOfZh0[], zh0 = (arrayOfZh0 = um0.Kt0.H9(paramj40.s5(), s2, j, paramj40.Zs.tm0()))[0]; int[] arrayOfInt = null; short s3 = paramj40.Zs.Vf0(); if (this.T == null && !um0.Kt0.rE0(paramj40.s5(), s3, j, paramj40.Zs.tm0())) { s3 = paramj40.Zs.Vf0(); (this.T = new UA0[2])[0] = um0.Kt0.vt(paramj40.s5(), s3, true, paramj40.Zs.tm0()); s3 = paramj40.Zs.Vf0(); this.T[1] = um0.Kt0.vt(paramj40.s5(), s3, false, paramj40.Zs.tm0()); this.T[0].Zz(Math.round(f)); this.T[1].Zz(Math.round(f)); UA0 uA0 = arrayOfUA0[0]; UA0[] arrayOfUA0; (arrayOfUA0 = this.T)[1].getClass(); ((arrayOfUA0 = this.T)[1]).vF0 = uA0.vF0; ((arrayOfUA0 = this.T)[1]).YM = uA0.YM; ((arrayOfUA0 = this.T)[1]).rS = uA0.rS; this.Pf.Nv((Object[])this.T); }  s3 = paramj40.Zs.Vf0(); if (um0.Kt0.F7(paramj40.s5(), s3, j, paramj40.Zs.tm0())) { short s = paramj40.Zs.Vf0(); arrayOfInt = um0.Kt0.Hr(paramj40.s5(), s, j, paramj40.Zs.tm0()); } else { arrayOfZh0 = null; }  double d = f * 0.5D; int j = (int)((zh0.Uu0()).H0 * f); int i = (int)((zh0.Uu0()).Vn0 * f); int m = 129 - (int)((zh0.Uu0()).H0 * d); int k = 100 - (int)((zh0.Uu0()).Vn0 * d); rH rH = this.mn.TS; if (paramj40.Zs.da()) { float f1; rH
/* 50 */         .V1 = 1.15F;
/* 51 */       if (paramj40.Zs
/* 52 */         .tm0()) { rH
/* 53 */           .bG0 = dM.d10; f1 = 1.0F; } else { rH
/*    */           
/* 55 */           .bG0 = dM.N1; f1 = 0.8F; }  rH
/* 56 */         .is = f1;
/* 57 */       rH.Vy = 1.5F; }  if (arrayOfZh0 != null && arrayOfZh0.length > 
/* 58 */       2) { rH.sm(arrayOfZh0); rH.s8(arrayOfInt); rH
/* 59 */         .vU = true;
/*    */ 
/*    */ 
/*    */ 
...
/*    */       
/*    */       if (paramBoolean)
/* 67 */       { rH.zT(m, k); rH.tL(j, i); return; }  } else { UA0[] arrayOfUA0; if ((arrayOfUA0 = this.T) != null) { rH.fc0(new UA0[] { arrayOfUA0[this.ny0] }); if (paramBoolean) { int n, i1; rH.Ef(); if (paramj40.Zs.da()) { n = rH.Cf0 + 72; i1 = rH.Tn + 68; } else { n = rH.Cf0 + 110; i1 = rH.Tn + 90; }  rH.zT(n, i1); }  } else { zh0[] arrayOfZh01; (arrayOfZh01 = new zh0[1])[0] = zh0; rH.sm(this); if (paramBoolean) { rH.zT(m, k); rH.tL(j, i);
/*    */           return; }
/*    */          }
/*    */        }
/*    */      }
