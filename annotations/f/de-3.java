/* 1 */ package f;public final class de extends V4 { public final nl eD(int paramInt1, int paramInt2, int paramInt3) { if (paramInt2 < 1) paramInt2 = 1;  if (paramInt3 < 1) paramInt3 = 1;  int i = 0; nl[] arrayOfNl2; int m;
...
/*   */ 
/*   */   
/*   */   public de(byte paramByte, byte... paramVarArgs) {
/*   */     super(paramByte, paramVarArgs[0], new nl[0]);
/*   */     if (paramVarArgs.length == 2) {
/*   */       nl[] arrayOfNl = new nl[paramVarArgs.length * 2];
/*   */       byte b;
/*   */       for (b = 0; b < paramVarArgs.length; b++)
/*   */         arrayOfNl[b] = nl.Tm0(paramVarArgs[b], NI.Ov0); 
/*   */       for (b = 0; b < paramVarArgs.length; b++) {
/*   */         int i = b + paramVarArgs.length;
/*   */         arrayOfNl[i] = nl.Tm0(LF.IW(paramVarArgs[paramVarArgs.length - 1 - b]), NI.Ov0);
/*   */       } 
/*   */       Gd(arrayOfNl);
/*   */       return;
/*   */     } 
...
/*   */     byte b = 0;
/*   */     nl[] arrayOfNl;
/*   */     while (b < (arrayOfNl = this.AC0).length / 2) {
/*   */       byte b1;
