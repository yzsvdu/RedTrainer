/*  1 */ package f;public final class A extends Qa0 implements r60 { public static final SimpleDateFormat Ds0 = new SimpleDateFormat("dd MMM hh:mm:ss a"); public final boolean zk; public Vq0 sr; public byte[] E60; public lK0 X3; public YA0 vz0; public zT EL0; public Rm bl; public BS ii; public Gn0 bk; public of TK0; public of zr0; public Un ir0; public int Ea; public bh[] YD0; public JG0 z8; public fv0[] uC0; public Te Vi; public oo dL; public boolean i6; public static void kA(fv0 paramfv0) { R8 r8 = km.u4; int i = paramfv0.y60; r8
/*  2 */       .e20
/*  3 */       .W3(new CoM1(i)); } public static void Bg(fv0 paramfv0) { R8 r8 = km.u4; int i = paramfv0.y60; boolean bool = true; r8.e20.W3(new nS(i, bool)); } public static void Wj(fv0 paramfv0) { R8 r8 = km.u4; int i = paramfv0.y60; boolean bool = true; r8.e20.W3(new nS(i, bool)); } public static void u10(bh parambh) { boolean bool; if (parambh.CG0() == 0) { bool = true; } else { bool = false; }  parambh.dX.Z30(bool); } public static void vf(bh parambh) { byte b; if (parambh.CG0() == 2) { b = 3; } else { b = 2; }  parambh.dX.Z30(b); } private void yW(Te paramTe, byte paramByte, int paramInt1, fv0[] paramArrayOffv0, int paramInt2, boolean paramBoolean, Qr paramQr) { // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: getfield E60 : [B
/*    */     //   4: aload_1
/*    */     //   5: getfield HC0 : B
...
/*    */     //   #196	-> 2820
/*    */     //   #197	-> 2823 }
/*  4 */   private void PI0(fv0 paramfv0) { if (!this.zk) { km.u4.Pq(Ml0.OH0(8029)); } else { int[] arrayOfInt; (arrayOfInt = new int[1])[0] = paramfv0.y60; km.u4.e20
/*  5 */         .W3(new Pt(this)); }  } public static void Qd0(fv0 paramfv0, LPT3 paramLPT3) { this(paramfv0, paramLPT3, paramfv0.nj0); Th0 th0; JG0 jG0; A a;
/*  6 */     if ((jG0 = (a = pA.Dg0.QI0).z8) == null) { a
/*  7 */         .z8 = th0; } else { jG0
/*  8 */         .ra0(); a.z8 = th0; }  a
/*  9 */       .si(th0, a.Ub()); } private void Wp(ey paramey) { j40 j40 = paramey.t70; pA.Dg0.u30(e9(), this); } public static void o7(fv0 paramfv0) { UB0.LL0.Zq(B40.df("https://manage.pokemmo.com/auctions/").append(paramfv0.y60).toString()); } public static void pb(fv0 paramfv0) { bF.wG0(paramfv0.y60 + ""); js.vu0.Pu(-1, "Auction id copied to clipboard"); } public static void Ac(Te paramTe, int paramInt1, int paramInt2, short paramShort) { km.u4.e20.W3(new cJ(paramTe, paramInt1, paramInt2, paramShort)); } public static void If(Calendar paramCalendar, SA paramSA, iv paramiv) { // Byte code:
/*    */     //   0: aload_2
...
/* 11 */       .cd(yA0);
/* 12 */     ((YA0)sA.Vs)
/* 13 */       .MJ0(); } private void tP() { boolean bool; Rc rc = JB0.CE0; BS bS; if ((bS = this.ii).hC0 > 0) { bool = true; } else { bool = false; }  F7.Yo(JB0.Ww(bS, rc, bool), this.ii); } private void Wy0() { if (this.ii.hC0 > 0) this.bk.zf(null);  T10(); } private void al() { if (this.sr.nv0() == 4) km.u4.e20.W3(new J4());  } private void N60(Te paramTe) { byte b; if (this.sr.nv0() == (b = paramTe.HC0)) { this.YD0[b].VI0(); mg(paramTe); }  } public A(j40 paramj40, boolean paramBoolean) { // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: iload_2
/*    */     //   2: aload_0
/*    */     //   3: dup
...
/* 17 */           .V1 = 2.0F;  paramSA
/* 18 */         .S7(new JG0())
/* 19 */         .Kw(); paramSA.S7(new JG0()).x70();
/* 20 */       nJ0 nJ0 = paramSA.S7(vF0).Ig0(32.0F); if (km.XU()) { f = 10.0F; } else { f = 5.0F; }  nJ0.sg(f); paramSA
/*    */ 
/*    */ 
/*    */         
/* 24 */         .fe(paramfv0.gh + "x " + Ml0.OH0(lPT3.Iu), "label-lalign").Kw(); paramSA.S7(new JG0())
/* 25 */         .Kw(); paramSA.S7(new JG0()).x70(); } else if (paramfv0
/* 26 */       .mm0 != null)
/* 27 */     { short s; byte b; this(); ey
/* 28 */         .XC0 = false;
/* 29 */       ey.ZF = false;
/* 30 */       ey.FO = false; ey ey;
/* 31 */       (ey = new ey()).sB0(paramfv0); if (km.XU()) { ey
/* 32 */           .un0 = 0; ey.ST = 0;
/* 33 */         ey.As
/* 34 */           .zT(0, -20);
/* 35 */         ey.As
/* 36 */           .V1 = 2.0F;
/* 37 */         ey.Xu("label"); }  nJ0 nJ0; (nJ0 = paramSA.S7(ey)).fu(); if (km.XU()) { nJ0.fJ(48.0F); nJ0.Ig0(130.0F); } else { nJ0.Ig0(70.0F); nJ0.fJ(40.0F); }
/* 38 */        Q90 q90; if ((q90 = paramfv0.mm0) != null)
/* 39 */       { b = q90.od; }
/* 40 */       else { b = paramfv0.nj0; }  if (q90 != null)
/* 41 */       { s = q90.Cw0; }
/* 42 */       else { s = s.bn; }  paramSA
/* 43 */         .S7(new Un(Ml0.OH0(59) + " " + b + " " + Ml0.OH0(s + 150000)))
/* 44 */         .Kw(); paramSA.S7(new Un(Ml0.OH0(59) + " " + b + " " + Ml0.OH0(s + 150000))).x70();
/* 45 */       paramSA.S7(new Un(Ml0.OH0(59) + " " + b + " " + Ml0.OH0(s + 150000))).kp0(); }  paramSA.wP(); } public static void Ur0(fv0 paramfv0, JG0 paramJG0) { if (!km.D70(1)) return;  this(); String str = B40.df("Auction #").append(paramfv0.y60).toString(); b3.mD(str, paramfv0::pb); b3.mD("ACP", paramfv0::o7); B3 b3; F7.Yo(b3 = new B3(), paramJG0); }
/*    */   public final void T10() { int i = 1, k = 1, m = 2000000000; BS bS; short s; if ((s = (bS = this.ii).hC0) > 0) { if ((k = bS.op0) > 0) i = k;  short s1 = gm.Ti0; LPT3 lPT3; if ((lPT3 = Of.eH.On0(s)).ID0 > 1) if (lPT3.wg0 != v7.Kj0) { m = 250000000; } else { m = 20000000; }   if (lPT3.TA0 && (int)((m = Math.round(lPT3.ph0 * 1.105F)) * gm.u90) < (s = gm.Ti0)) { m = Math.round(lPT3.ph0 * 1.05F + s); short s2 = s1; } else { short s2 = s1; }  }  j40 j40; if ((j40 = this.bk.t70) != null) if (j40.Zs.tm0()) { k = gm.md; } else { k = gm.K20; }   int n = this.bl.T8; this(0, m, n); String str; zT zT1; this.EL0 = new zT(); this.bl.pe(zT1); this.bl.l4(this.bl.T8); this.Ea = k; this.EL0.Ac0(this::T10); int j; if (((m = (int)((j = this.bl.T8) * gm.u90)) < (n = gm.K20) && this.bk.t70 != null) || m < (n = gm.Ti0)) m = n;  if (m > (n = gm.gx0))
/* 47 */       m = n;  i = m * i; this.TK0.Be0(B40.df("$").append(NumberFormat.getInstance().format(i)).toString(), false); long l; if ((l = i * j) > 2000000000L) { str = Ml0.Go(8048, NumberFormat.getInstance().format(2000000000L)); this.ir0.z4 = this; this.ir0.zn(); this.ir0.sk0(false); this.ir0.jl = 0; this.zr0.z4 = this; this.zr0.zn(); this.zr0.jl = 0; this.zr0.Be0(B40.df("(!!) $").append(NumberFormat.getInstance().format(l)).toString(), false); } else { ((A)super).ir0.z4 = null; ((A)super).ir0.zn(); ((A)super).zr0.Be0(B40.df("$").append(NumberFormat.getInstance().format(l)).toString(), false);
/* 48 */       ((A)super).zr0
/* 49 */         .z4 = null;
/* 50 */       ((A)super).zr0.zn(); if (l > 0L) ((A)super)
/* 51 */           .ir0.sk0(true);  }
/*    */      }
/*    */ 
/*    */   
