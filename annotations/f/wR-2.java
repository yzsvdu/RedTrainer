/* 1 */ package f;public final class wR extends Writer { public final void q00() { if (!this.iK)
/* 2 */     { Lv0 lv0; byte b; Writer writer = ((Lv0)this.b7.pop()).Gy0.CoM9; if (((Lv0)this.b7.pop()).xX) { b = 93; } else { b = 125; }  writer.write(b); fQ fQ1;
/* 3 */       if ((fQ1 = this.b7).Z8 == 0) { fQ1 = null; } else { lv0 = (Lv0)fQ1.peek(); }  this.x30 = lv0; return; }  throw new IllegalStateException("Expected an object, array, or value since a name was set."); }
/*   */ 
/*   */   
