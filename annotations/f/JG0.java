...
public class JG0 {
    public static final Ll e30;
    public static final Ll OL0;
    public static final Ll jz0;
    public static final Ll PA;
    public static final ThreadLocal Kc;
    public static final boolean zE0;
    public JG0 fr0;
    public int Kd;
    public int er0;
    public int xY;
    ...
    public gg0 cu;
    public I db0;
    public PropertyChangeSupport kD0;
    public volatile throws Bo0;
    public final Sa0 O;
    ...
    public JG0(Sa0 paramSa0, boolean paramBoolean) {
        Sa0 sa0;
        this.dP = true;
        this.kN = true;
        this.fx = true;
        ...
        this.fd = -1;
        this.cl = TI();
        if (paramSa0 == null || paramBoolean) {
            this(paramSa0);
            this.O = this;
            this.lPt4 = false;
            return;
        }
        ((JG0) super).O = paramSa0;
        ((JG0) super).lPt4 = true;
    }

    public static int Fr(int paramInt1, int paramInt2, int paramInt3) {
        if (paramInt3 > 0) paramInt2 = Math.min(paramInt2, paramInt3);
        return Math.max(paramInt1, paramInt2);
    }

    static {
        Logger.getLogger(JG0.class.getName());
        e30 = Ll.F10("keyboardFocus");
        OL0 = Ll.F10("hasOpenPopups");
        jz0 = Ll.F10("hasFocusedChild");
        PA = Ll.F10("disabled");
        Kc = new ThreadLocal();
        try {
            bool = Boolean.getBoolean("warnOnUnhandledAction");
    ...
    public static void Sz(JG0 paramJG0) {
        while (paramJG0 != null) {
            JG0 jG0 = paramJG0.LG;
            if (!paramJG0.lPt4) paramJG0.O.gf0(e30, false);
            try {
                paramJG0.GD();
            } catch (Exception exception) {
                Ni0().log(Level.SEVERE, "Exception in keyboardFocusLost()", exception);
            }
            paramJG0.LG = null;
            paramJG0 = jG0;
        }
    ...
    private static Logger Ni0() {
        return Logger.getLogger(JG0.class.getName());
    }

    public final int rl(ArrayList<JG0> paramArrayList) {
        d10 d101;
        if ((d101 = this.Li0) == null) return -1;
        int i;
        Hc0 hc0;
        for (i = -1, hc0 = d101.r30(); hc0.hasNext(); ) {
            if ((jG0 = (JG0) hc0.next()).dP && jG0.kN) {
                if (jG0.zI0) {
                    if (jG0 == this.LG) i = paramArrayList.size();
                    paramArrayList.add(jG0);
                }
                int j;
                if (jG0.te && (j = jG0.rl(paramArrayList)) != -1) i = j;
            }
        }
        return i;
    }

    public final void Wi0(throws paramthrows) {
        if (kx0 || this.Bo0 == null) {
            this.Bo0 = paramthrows;
            d10 d101;
            if ((d101 = this.Li0) != null) {
                JG0[] arrayOfJG0 = (JG0[]) d101.Jv0();
                int i = this.Li0.Z8;
                while (i-- > 0) arrayOfJG0[i].Wi0(paramthrows);
                this.Li0.At0();
            }
            return;
        }
    ...
    public final void A8(throws paramthrows) {
        if (kx0 || this.Bo0 == paramthrows) {
            if (this.kM != 0) paramthrows.RF = true;
            if (!this.lPt4) this.O.lg0(paramthrows);
            try {
                LM(paramthrows);
            } catch (Exception exception) {
                Ni0().log(Level.SEVERE, "Exception in afterAddToGUI()", exception);
            }
            d10 d101;
            if ((d101 = this.Li0) != null) {
                JG0[] arrayOfJG0 = (JG0[]) d101.Jv0();
                int i = this.Li0.Z8;
                while (i-- > 0) arrayOfJG0[i].A8(paramthrows);
                this.Li0.At0();
            }
            return;
        }
    ...
    public final void gb(throws paramthrows) {
        if (kx0 || this.Bo0 == paramthrows) {
            this.Bo0 = null;
            this.Lg = null;
            d10 d101;
            if ((d101 = this.Li0) != null) {
                JG0[] arrayOfJG0 = (JG0[]) d101.Jv0();
                int i = this.Li0.Z8;
                while (i-- > 0) arrayOfJG0[i].gb(paramthrows);
                this.Li0.At0();
            }
            return;
        }
    ...
    public final void Zk(JG0 paramJG0) { throws throws1 = this.Bo0;
        if (paramJG0.q50) if (kx0 || throws1 != null)
            /*  3 */ {
            for (int k = throws1.Ub() - 2; k-- > 1; )
                /*    */ {
                iz0 iz0;
                JG0 jG0;
                /*  5 */
                for (jG0 = (iz0 = (iz0) throws1.lPt3(k)).AU; jG0 != null && jG0 != paramJG0; )
                    /*  6 */
                    jG0 = jG0.fr0;
                if ((jG0 == paramJG0)) throws1
/*  7 */.Kc(iz0);
            }
        } else {
        ...
        /*  8 */
        Sz(paramJG0);
        if (throws1 != null) paramJG0.yF0(throws1);
        paramJG0.gb(throws1);
        paramJG0.fr0 = null;
        try {
            paramJG0.jA0();
        } catch (Exception exception) {
            Ni0().log(Level.SEVERE, "Exception in destroy()", exception);
        }
        int i = -this.Kd, j = -this.er0;
        paramJG0
/*  9 */.ME(paramJG0.Kd + i, paramJG0.er0 + j);
        /* 10 */
        paramJG0.o40(null, paramJG0.fx);
    }

    public final void yF0(throws paramthrows) {
        if (kx0 || this.Bo0 == paramthrows) {
            d10 d101;
            if ((d101 = this.Li0) != null) {
                JG0[] arrayOfJG0 = (JG0[]) d101.Jv0();
                int i = this.Li0.Z8;
                while (i-- > 0) arrayOfJG0[i].yF0(paramthrows);
                this.Li0.At0();
            }
            this.LG = null;
            if (!this.lPt4) this.O.lg0(null);
            try {
                ED0(paramthrows);
            } catch (Exception exception) {
                Ni0().log(Level.SEVERE, "Exception in beforeRemoveFromGUI()", this);
            }
            return;
        }
        throw new AssertionError("guiInstance must be equal to gui");
    ...
    public final void o40(throws paramthrows, boolean paramBoolean) {
        paramBoolean &= this.fx;
        if (this.kN != paramBoolean) {
            this.kN = paramBoolean;
            if (!this.lPt4) {
                Ll ll = PA;
                this.O.gf0(ll, paramBoolean ^ true);
            }
            if (!paramBoolean) {
                if (paramthrows != null) {
                    if (this instanceof iz0) paramthrows.Kc((iz0) this);
                    paramthrows.Uj0(this);
                }
                try {
                    V7();
                } catch (Exception exception) {
                    Ni0().log(Level.SEVERE, "Exception in widgetDisabled()", exception);
                }
                try {
                    xI0();
                } catch (Exception exception) {
                    Ni0().log(Level.SEVERE, "Exception in giveupKeyboardFocus()", exception);
                }
            }
            try {
                String str = "enabled";
                lH(str, paramBoolean ^ true, paramBoolean);
            } catch (Exception exception) {
                Ni0().log(Level.SEVERE, "Exception in firePropertyChange(\"enabled\")", exception);
            }
            d10 d101;
            if ((d101 = this.Li0) != null) {
                JG0[] arrayOfJG0;
                int i;
                for (arrayOfJG0 = (JG0[]) d101.Jv0(), i = this.Li0.Z8; i-- > 0; arrayOfJG0[i].o40(paramthrows, paramBoolean))
                    ;
                this.Li0.At0();
            }
        }
    ...
    public final void NL0(throws paramthrows) {
        C7 c72;
        if (this.db0.en) zG0();
        float f1 = this.db0. transient[0],f2 = this.db0. transient[1],f3 = this.db0. transient[2],f4 = this.db0.
        transient[3];
        tw tw;
        C7 c71;
        if ((c71 = (tw = (tw) paramthrows.IB0).Ma).JJ == null) {
            C7 c7;
            this(c71);
            c71.JJ = c7;
        }
    ...
    public final void Kr0(throws paramthrows) {
        tw tw;
        int i = this.Kd, j = this.er0, k = this.xY, m = this.HC;
        tw.X2(i, j, k, m);
        try {
            int n = this.Kd, i1 = this.er0;
            i = this.xY;
            j = this.HC;
            WN(paramthrows, n, i1, i, j);
            return;
        } finally {
            tw.Hq0();
        }
    ...
    public final void w00(dS paramdS, nY paramnY, lI paramlI) {
        d10 d101;
        if ((d101 = this.Li0) != null && paramnY != null) {
            JG0[] arrayOfJG0;
            byte b;
            int i;
            for (arrayOfJG0 = (JG0[]) d101.Jv0(), b = 0, i = this.Li0.Z8; b < i; ) {
                nY nY1;
                JG0 jG0;
                (jG0 = arrayOfJG0[b]).Lg = paramdS;
                if ((arrayOfJG0[b]).cl.length() > 0) {
                    try {
                        boolean bool;
                        String str;
                        if ((str = jG0.cl).length() > 1 && str.charAt(0) == '/') {
                            bool = true;
                        } else {
                            bool = false;
                        }
    ...
    public final StringBuilder Jr(int paramInt) {
        StringBuilder stringBuilder;
        boolean bool;
        paramInt = this.cl.length() + paramInt;
        String str;
        if ((str = this.cl).length() > 1 && str.charAt(0) == '/') {
            bool = true;
        } else {
            bool = false;
        }
        JG0 jG0;
        if ((jG0 = this.fr0) != null && !bool) {
            stringBuilder = jG0.Jr(paramInt + 1);
            if (this.cl.length() > 0 && stringBuilder.length() > 0) stringBuilder.append('.');
        } else {
            StringBuilder stringBuilder1;
            this(stringBuilder);
            stringBuilder = stringBuilder1;
        }
        return bool ? stringBuilder.append(this.cl.substring(1)) : stringBuilder.append(this.cl);
    }
    ...
    public final void HM(PropertyChangeListener paramPropertyChangeListener) {
        if (this.kD0 == null) {
            PropertyChangeSupport propertyChangeSupport;
            this(this);
            this.kD0 = propertyChangeSupport;
        }
        this.kD0.addPropertyChangeListener(paramPropertyChangeListener);
    }

    public final JG0 Mv0() {
        return this.fr0;
    }

    public final boolean Ji0(JG0 paramJG0) {
        return ((this = this.fr0) == null) ? false : ((this == paramJG0) ? true : Ji0(paramJG0));
    }
    ...
    public void jA0() {
        ...
        if (this.fd > 0) {
            vw vw = ((tw) this.Bo0.IB0).fw;
            int i = this.fd;
            if (this.VK == null) {
                fQ fQ;
                if (i == (fQ = this.Bs).Z8 - 1) {
                    dd0 = (Dd0) fQ.Hc(i);
                    this.n3.Dt0.w0().limit(dd0.Zr0);
                    if (this.VK == null) {
                        this.n3.rs0
/* 12 */.pP();
                        /*    */
                        ...
                        /*    */
                        /* 16 */
                        this(this.Bs.Z8, this.n3.Dt0.w0().limit());
                        this.VK = new Dd0();
                        this.Bs.Com3(dd0);
                        this.n3
/* 17 */.Dt0
...
/* 23 */.position(this.VK.Zr0);
                ...
                if ((dd0 = this.VK) != null)
                    ...
                    /*    */ {
                    /* 27 */
                    int k, j = this.n3.Dt0.w0().position() - dd0.Zr0;
                    Texture[] arrayOfTexture;
                    if ((arrayOfTexture = dd0.Yl) == null) {
                        for (dd0.m4 = j, dd0.Hs0 = this.qH0.Z8, dd0.Yl = (Texture[]) this.qH0.Ib(Texture.class), dd0.YD = new int[dd0.Hs0], j = 0, k = this.Rf.mG0; j < k; ) {
                            dd0.YD[j] = this.Rf.Vl(j);
                            j++;
                        }
                        this.n3
/* 28 */.Dt0
...
/* 30 */.flip();
                        ...
                        dd0.Hs0 = j = this.qH0.Z8;
                        if (k.length < j) dd0.Yl = new Texture[j];
                        for (k = 0; k < j; ) {
                            dd0.Yl[k] = (Texture) this.qH0.get(k);
                            k++;
                        }
                        if (dd0.YD.length < (j = dd0.Hs0)) dd0.YD = new int[j];
                        for (k = 0; k < j; ) {
                            dd0.YD[k] = this.Rf.Vl(k);
                            k++;
                        }
                        this.n3
/* 31 */.Dt0
/* 32 */.w0()
/* 33 */.position(0);
                        this.n3.Dt0.w0().limit((dd0 = (Dd0) this.Bs.get(this.Bs.Z8 - 1)).Zr0 + dd0.m4);
                    }
                    /*    */
                    else
                        /* 35 */ {
                        throw new JU(
                                /*    */
                                /*    */
                                /* 38 */                 N.Gl0(HB0.DH0("If a cache is not the last created, it cannot be redefined with more entries than when it was first created: ", j, " ("), dd0.m4, " max)"));
                    }
                    this.VK = null;
                    this.qH0.clear();
                    this.Rf.mG0 = 0;
